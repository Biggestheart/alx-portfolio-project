    ...
    if request.method == "POST":
        if "signup_post" in request.POST:
            ...
            if pswd != pswd2:
                ...
                otp_purpose = "signup"
                send_mail(
                    "BiggestHeart-Password-Manager Password Manager: Confirm Email",
            ...
            if input_otp != global_code:
                ...
                if(otp_purpose=="signup"):
                    ...
                    if not new_user==None:
                        ...
                        msg = f"{new_user_data[0]}. Thanks for registering with BiggestHeart."
                        msg_page_data = {
                            "text":msg, 
                            "code":True, 
                        }
                        ...
                        send_mail(
                        "Welcome to BiggestHeart-Password-Manager.",
                        message,
                        settings.EMAIL_HOST_USER,
                        [new_user_data[1]],
                        fail_silently=False,
            ...
            if not User.objects.filter(email=email).exists():
                ...
                send_mail(
                    "BiggestHeart-Password-Manager Password Manager: Passsword Reset",
            ...
            send_mail(
                "BiggestHeart-Password-Manager Password Manager: Account Delete",
